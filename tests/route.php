...
class Test_Route extends \Fuel\Core\TestCase
{
	...
	public function test_reverse_route()
	{
		...
		$this->assertEquals(
			\Seo\Route::reverse_route('hoge/fuga'),
			'sample'
		);
		...
		$this->assertEquals(
			\Seo\Route::reverse_route('hoge/category/35'),
			'cat/35'
		);
		// no num no matched
		$this->assertEquals(
			\Seo\Route::reverse_route('hoge/category/hoge'),
			'hoge/category/hoge'
		);
		...
		$this->assertEquals(
			\Seo\Route::reverse_route('a/i/u/1'),
			'cat/1/u'
		);
		...
		$this->assertEquals(
			\Seo\Route::reverse_route('a/i/0a2/33/str'),
			'cat/33/str/0a2'
		);
